...
from models.m3.models import AENet


from models.m3.detector import CelebASpoofDetector
...
class TSNPredictor(CelebASpoofDetector):
    ...
    def __init__(self):
        ...
        checkpoint = torch.load('models/m3/files/ckpt_iter.pth.tar',map_location=torch.device('cpu'))
